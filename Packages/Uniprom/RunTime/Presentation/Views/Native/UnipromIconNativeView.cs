...
namespace Uniprom
{
    [AddComponentMenu("Uniprom/View/UnipromIconNativeView")]
    public sealed class UnipromIconNativeView : UnipromIconModelsProvider
    {
        ...
        protected override bool AutoReload() => false;
        
        protected override float ReloadInterval() => 0;

        protected override void OnLoadModels(List<UnipromIconModel> models, bool isReload)
        {
            if (isReload)
            {
